"""
Author: Yixi Zhang
Here a GNN is constructed with optimizrd hyperparameters and also ONLY retained molecules.
(The best parameters shown in SMRT_hpop_advanced5)
...
mp = nn.BondMessagePassing (d_h = 495)
...
# Set up the trainer
log_dir = "/home/user/YixiTFG/TFG_Yixi/SMRT_mol_desc/3.SMRT_mol_desc_GNN_hopted/logs/"
logger = CSVLogger (
    save_dir=log_dir,
)
...
res_path = "/home/user/YixiTFG/TFG_Yixi/SMRT_mol_desc/3.SMRT_mol_desc_GNN_hopted/Results/Results_GNN_hpopted.tsv"
...
def MAE_RMSE_from_dataframe (dataframe):
    ...
    """
    MAE = np.mean (dataframe["diff"])
    RMSE = np.sqrt(np.sum(dataframe["diff"]**2)/dataframe.shape[0])
    return MAE, RMSE

MAE, RMSE = MAE_RMSE_from_dataframe (res_table)

metric_res_file = "/home/user/YixiTFG/TFG_Yixi/SMRT_mol_desc/3.SMRT_mol_desc_GNN_hopted/Results/Results_metrics.txt"
...
logger_path = "/home/user/YixiTFG/TFG_Yixi/SMRT_mol_desc/3.SMRT_mol_desc_GNN_hopted/logs/lightning_logs/version_0/metrics.csv"
res_path = "/home/user/YixiTFG/TFG_Yixi/SMRT_mol_desc/3.SMRT_mol_desc_GNN_hopted/Results/"
