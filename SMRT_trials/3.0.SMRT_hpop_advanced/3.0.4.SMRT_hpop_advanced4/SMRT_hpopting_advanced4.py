"""
Here, hyperparameter optimization is run with early stopping mechanism implemented.
Not only that, but the search space is algo different. Depth is also tuned, because reviewing literatures, seen than depth > 3.
"""
...
def objective(trial):
    ...
    # Model
    mp = nn.BondMessagePassing(d_h=mp_hidden_dim, depth=depth)
...
path2file = "/home/user/YixiTFG/TFG_Yixi/SMRT_trials/3.0.SMRT_hpop_advanced/3.0.4.SMRT_hpop_advanced4/Results_hpop_advanced4.tsv"
