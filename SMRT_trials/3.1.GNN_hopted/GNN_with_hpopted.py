"""
3.1. GNN_with_hpopted
Author: Yixi Zhang
A GNN is constructed using the best parameters according to the optimization process. (See 3.0_SMRT_hpop_advanced/Restults_hpop_advanced.txt)
In concrete, the parameters used are these below:
    mp_hidden_dim = 907
    ffn_hidden_dim = 1097
    ffn_layers = 2
    init_lr = 7e-5
    max_lr = 2e-3
    warm_up_epochs = 2 (Default value, not tuned)
    dropout = 0.1
    max_epochs = 100 (Not tuned)
Comparing to GNN0, MAE decreased in 3s aprox. and RMSE in 8s.
...
# csv_data_file = "C:/Users/leonz/Github_reps/TFG_git/SMRT_trials/SMRT_Data/SMRT_dataset.csv"
...
mp = nn.BondMessagePassing (d_h=907)
...
mpnn = models.MPNN (mp, agg, ffn, batch_norm, metrics, init_lr=7e-5, max_lr=0.002)

# 6. Training configuration

checkpointing = ModelCheckpoint (
    "/home/user/YixiTFG/TFG_Yixi/SMRT_trials/3.1.GNN_hopted/checkpoints",
    "best_{epoch}",
    "val_loss",
    mode = "min",
    save_last = True,
...
#saving_path = "C:/Users/leonz/Github_reps/TFG_git/SMRT_trials/3.1.GNN_hopted/saved_model.pt"
saving_path = r"/home/user/YixiTFG/TFG_Yixi/SMRT_trials/3.1.GNN_hopted/saved_model.pt"
...
#filename = r'C:/Users/leonz/Github_reps/TFG_git/SMRT_trials/3.1.GNN_hopted/Results_GNN_hpopted.txt'
filename = r'/home/user/YixiTFG/TFG_Yixi/SMRT_trials/3.1.GNN_hopted/Results_GNN_hpopted.txt'
